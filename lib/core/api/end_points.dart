class EndPoints {
  ...
  static const String getWishlistItemsApi = '/api/v1/wishlist';
  static const String deleteWishlistItemsApi = '/api/v1/wishlist';
  static const String updateLoggedUseApi = '/api/v1/users/updateMe/';
}